---
name: measurement-sciences
description: "Design and audit measurement and evaluator systems: construct, validity evidence, precision, fairness, uncertainty, consequences, and improvement. Not a universal PhD standard."
---

# Measurement sciences and evaluator design

## Purpose

Use this skill to operationalize competency F2-COMP-67-MEASUREMENT-001 as a bounded,
...
Use it for measurement and evaluator-design analyst when the user supplies a domain task, case, passage,
study, policy record, model, or design record. Do not use it as a
credentialing authority, psychometric sign-off, or automatic high-impact decision-maker.
...
- define construct, use, population, and consequences
- design measures and evidence
- evaluate validity, precision, uncertainty, and fairness
- interpret and report
- audit and improve evaluators

## Evidence requirements

- construct and decision map
- validity or evidence argument
- precision, uncertainty, fairness, and accessibility review
- transparent technical report
- improvement and residual-risk memo
...
- Do not treat a score as the construct or claim validity/fairness without an evidence argument; label composite and exemplar layers.
...
Measurement expert owns consequential interpretation, fairness, accessibility, and decision boundaries.
